      ...
      <main className="prose max-w-none text-base">
        ...
        <div className="">
          ...
          <p>
            ...
            of the orgnaization. This includes all areas of the online banking
            ...
            with the accesibility consultants and learn from them. This is not
            available at many companies, and is something that has been
            invaluable. Below are a couple examples of the type of components
            created.
            <PhotoProvider>
        ...
        <div className="">
          ...
          <p>
            ...
            Testing using NVDA was completed by developer prior to going to QA.
            This was my first big dive into developing to the WCAG 2.0
            standards.
          </p>
          <PhotoProvider>
          <article className="flex flex-row justify-center items-center">
        ...
        <div className="">
          ...
          <p>
            ...
            Many were as simple fixing alt tags, where they didn't uncerstand
            the proper usage.
          </p>
          <PhotoProvider>
          <article className="flex flex-row justify-center items-center">
